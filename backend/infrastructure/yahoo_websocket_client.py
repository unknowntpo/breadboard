...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if cmd == "--estimate":
            ...
            print("Usage:")
            print("  python -m backend.infrastructure.yahoo_websocket_client                           # Real-time WebSocket monitoring")
            print("  python -m backend.infrastructure.yahoo_websocket_client --estimate                # Historical data size estimation")
            print("  python -m backend.infrastructure.yahoo_websocket_client --candle SYMBOL START END # Candlestick data for date range")
            print("\nExamples:")
            print("  python -m backend.infrastructure.yahoo_websocket_client --candle AAPL 2024-12-09 2024-12-09  # Single day")
            print("  python -m backend.infrastructure.yahoo_websocket_client --candle AAPL 2024-12-01 2024-12-10  # Date range")
            print("  python -m backend.infrastructure.yahoo_websocket_client --candle NVDA 2023-01-01 2023-12-31  # Full year")
        else:
